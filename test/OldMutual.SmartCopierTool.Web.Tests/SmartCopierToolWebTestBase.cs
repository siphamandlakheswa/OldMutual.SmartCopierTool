...
{
    public abstract class SmartCopierToolWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartCopierToolWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartCopierToolWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartCopierToolDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartCopierToolDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartCopierToolDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartCopierToolDbContext, Task<T>> func)
        {
            T result;
