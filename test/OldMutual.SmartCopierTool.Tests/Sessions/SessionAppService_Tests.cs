...
using Shouldly;
using Xunit;
using OldMutual.SmartCopierTool.Sessions;

namespace OldMutual.SmartCopierTool.Tests.Sessions
{
    public class SessionAppService_Tests : SmartCopierToolTestBase
    {
